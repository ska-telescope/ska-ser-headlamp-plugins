...
function PrometheusMetrics(resource: DetailsViewSectionProps) {
  const PROMETHEUS_DATACENTRE_LABEL = process.env.REACT_APP_PROMETHEUS_DATACENTRE_LABEL || null
  const datacentreLabel = PROMETHEUS_DATACENTRE_LABEL ? `datacentre='${PROMETHEUS_DATACENTRE_LABEL}',` : ''
