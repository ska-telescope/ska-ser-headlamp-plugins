  ...
  component: () => {
    return (
      <SectionBox title="TANGO" textAlign="center" paddingTop={2}>
        {/* <TangoOperatorSummary></TangoOperatorSummary>
        <TangoResourcesSummery></TangoResourcesSummery>
...
registerDetailsViewSectionsProcessor(function addSubheaderSection(
  ...
  let targetIdx = sections.findIndex(
    (section) => section.id === "helm_section"
  );
  ...
  sections.splice(targetIdx + 1, 0, {
    id: tangoSection,
    section: (
      <NamespacedTangoResources namespace={resource}></NamespacedTangoResources>
    ),
  });
